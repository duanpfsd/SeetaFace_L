...
{
  std::string path = "D:\\pythonPath\\58test2\\test\\";
...

  {
    ...
    while (_findnext(hFile, &fileInfo) == 0)
    {
      ...
      if (!(fileInfo.attrib&_A_SUBDIR))
      {
        ...
        cout << ncount << "  Thread Fun1 Display!" << endl;
      }//if _A_SUBDIR
    }//while
  }//namespace
...

  {
    ...
    while (_findnext(hFile, &fileInfo) == 0)
    {
      ...
      if (!(fileInfo.attrib&_A_SUBDIR))
      {
        ...
        cout << ncount << "  Thread Fun2 Display!" << endl;
      }//if _A_SUBDIR
    }//while
  }//namespace
...

  {
    ...
    while (_findnext(hFile, &fileInfo) == 0)
    {
      ...
      if (!(fileInfo.attrib&_A_SUBDIR))
      {
        ...
        cout << ncount << "  Thread Fun3 Display!" << endl;
      }//if _A_SUBDIR
    }//while
  }//namespace
...

  {
    ...
    while (_findnext(hFile, &fileInfo) == 0)
    {
      ...
      if (!(fileInfo.attrib&_A_SUBDIR))
      {
        ...
        cout << ncount << "  Main Thread Display!" << endl;
      }//if _A_SUBDIR
    }//while
  }//namespace
  return 0;
